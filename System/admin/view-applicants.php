								...
								<div class="admin-content-wrapper">
									...
									<div class="container-fluid">
                                        ...
                                        <div class="col-md-12 ">
                                                ...
                                                <table class="table table-bordered bg-light border-dark bg-white " id="dataTable" width="100%" cellspacing="0" >
                                                    <thead>
                                                        <tr class="text-center">
                                                            <th class="text-center">Applicant Name</th>
                                                            <th class="text-center">Expertise</th>
                                                            <th class="text-center">Total Jobs Applied</th>
                                                    ...
                                                    <?php include '../constants/db_config.php'; 
                                                                ...
                                                                foreach($result as $row) {
                                                                    ...
                                                                    $memberno = $row['member_no'];
                                                                        ...
                                                                        $application_count_query = $conn->prepare("SELECT count(*) FROM tbl_job_applications WHERE member_no = :memberno");
                                                                        $application_count_query->bindParam(':memberno', $memberno);
                                                                        $application_count_query->execute();
                                                                        $applied_count = $application_count_query->fetchColumn();     
