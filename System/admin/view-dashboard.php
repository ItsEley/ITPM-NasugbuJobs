	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="admin-container-wrapper">
			 ...
			 $results = mysqli_query($conn, "SELECT * FROM tbl_verify"); ?>

                <table class="table table-bordered bg-white border-dark" id="dataTable" width="100%" cellspacing="0" >
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Member No</th>
                    ...
                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?php echo $row['id']; ?>" class="edit_btn btn btn-primary">Accept</a>
                                <a href="deny-verification.php?id=<?php echo $row['id']; ?>" class="del_btn btn btn-danger">Deny</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
