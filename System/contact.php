					...
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<textarea id="inputMessage" name="message" class="form-control" rows="8" data-minlength="1" data-error="Must contain atleast 1 chararacter" required></textarea>
											<div class="help-block with-errors"></div>
										</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Nasugbu,Batangas, <br/>Philippines</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:nasugbujobs@gmail.com">nasugbujobs@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+639999999999">+6399 9999 9999</a>
								</li>
