...
$stmt = $conn->prepare("INSERT INTO tbl_academic_qualification (member_no, barangay, institution, course, level, timeframe, certificate, transcript) VALUES 
(:member, :barangay, :institution, :course, :level, :timeframe, '$certificate', '$transcript')");
