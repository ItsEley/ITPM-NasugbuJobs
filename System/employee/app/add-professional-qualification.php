...
header("location:../qualifications.php?r=2290");
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_professional_qualification (member_no, barangay, institution, title, timeframe, certificate) VALUES (:memberno, :barangay, :institution, :title, :timeframe, '$certificate')");
