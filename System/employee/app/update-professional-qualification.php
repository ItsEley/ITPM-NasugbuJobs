...
if ($certificate == "") {
$sql = "UPDATE tbl_professional_qualification SET barangay = '$barangay', institution = '$institution', title = '$course', timeframe = '$timeframe' WHERE id='$id' AND member_no = '$myid'";
...
$sql = "UPDATE tbl_professional_qualification SET barangay = '$barangay', institution = '$institution', title = '$course', timeframe = '$timeframe', certificate = '$certificate'  WHERE id='$id' AND member_no = '$myid'";
