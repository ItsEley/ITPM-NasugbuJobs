...
<head>
   ...
   function update(str)
   {
    ...
    if (r == true) {
      ...
      xmlhttp.open("GET","app/apply-verification.php?opt="+str, true);
      xmlhttp.send();
    } else {
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
                                        ...
                                        <li>
											<a href="verify-account.php"><i class="fa fa-group"></i> Verify Account</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form action="app/verify-account.php" method="POST" enctype="multipart/form-data">
										...
										?><a onclick = "return confirm('Are you sure you want to delete your Verification ID ?')" class="btn btn-primary btn-inverse" href="app/drop-verify-id.php">Delete</a> <?php
										}
										?>
										</div>
