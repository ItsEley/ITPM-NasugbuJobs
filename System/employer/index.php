												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<select name="barangay" required class="selectpicker show-tick form-control" data-live-search="false">
                                                           ...
                                                           {
		                                                    ?> <option <?php if ($barangay == $row['barangay_name']) { print ' selected '; } ?> value="<?php echo $row['barangay_name']; ?>"><?php echo $row['barangay_name']; ?></option> <?php
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								<ul class="bottom-footer-menu for-social">
									<li><a href="<?php echo "$tw"; ?>"><i class="ri ri-twitter" data-toggle="tooltip" data-placement="top" title="twitter" target="_blank"></i></a></li>
									<li><a href="<?php echo "$fb"; ?>"><i class="ri ri-facebook" data-toggle="tooltip" data-placement="top" title="facebook" target="_blank"></i></a></li>
									<li><a href="<?php echo "$ig"; ?>"><i class="ri ri-instagram" data-toggle="tooltip" data-placement="top" title="instagram" target="_blank"></i></a></li>
								</ul>
							</div>
