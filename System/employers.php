...
<head>
	...
	<title>Nasugbu Jobs - Companies</title>
	...
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="images/ico/144x144.png">
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="images/ico/128x128.png">
		...
		<header id="header">
				...
				<div class="container">
					...
					<div class="nav-mini-wrapper">
						...
						print '
							...
							<li><a data-toggle="modal" href="#registerModal">SIGNUP</a></li>';						
						}
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title text-center">CRETAE YOUR ACCOUNT NOW!</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">SIGNUP AS EMPLOYER</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">SIGNUP AS EMPLOYEE</a>
						</div>
				...
				<div class="container">
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
							...
							<p class="mata-p clearfix"><span class="text-primary font700"></span> <span class="font13">View job post(s)</span> <span class="pull-right icon"><i class="fa fa-long-arrow-right"></i></span></p>
							</div>
