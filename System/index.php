...
<head>
	...
	<title>Nasugbu Jobs - Index<?php echo "$compname"; ?></title>
...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/background-banner.jpg');">
				<div class="container">

					<h1>kickstart your career today!</h1>
					<p>Find your next job on Nasugbu Jobs</p>
